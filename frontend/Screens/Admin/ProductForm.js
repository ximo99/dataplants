...
import { Item, Picker, Toast, Select, VStack } from "native-base";
...
const ProductForm = (props) => {
  ...
  const addProduct = async() => {
    ...
    if (item !== null) {
      console.log("AXIOS")
      console.log("baseUr", baseURL, item.id, formData, config)
      console.log(`${baseURL}products/${item.id}`)
      const res = await axios.put(`${baseURL}products/${item.id}`, { hello: 'world' });
      console.log("RES", res);
      /*axios
          ...
          if (res) {
            if (res.status == 200 || res.status == 201) {
              Toast.show({
                ...
                description: "The product successfuly updated.",
                status: "success",
                duration: 2000,
                isClosable: true,
              });
      ...
      axios
        ...
        .then((res) => {
          if (res.status == 200 || res.status == 201) {
            Toast.show({
              title: "Added Product.",
              description: "The new product was added to the DB.",
              status: "success",
              duration: 2000,
              isClosable: true,
            });
  ...
  return (
    <FormContainer title="Add Product">
      ...
      <VStack alignItems="center" space={4} style={styles.inputCategories}>
        <Select
          mode="dropdown"
